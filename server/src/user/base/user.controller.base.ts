...
export class UserControllerBase {
  ...
  @common.Get("/:id/photosToUsers")
  @ApiNestedQuery(PhotoFindManyArgs)
  async findManyPhotosToUsers(
    @common.Req() request: Request,
    @common.Param() params: UserWhereUniqueInput
  ): Promise<Photo[]> {
    const query = plainToClass(PhotoFindManyArgs, request.query);
    const results = await this.service.findPhotosToUsers(params.id, {
      ...query,
      select: {
        createdAt: true,
        geo: true,
  ...
  @common.Post("/:id/photosToUsers")
  async connectPhotosToUsers(
    @common.Param() params: UserWhereUniqueInput,
  ...
  @common.Patch("/:id/photosToUsers")
  async updatePhotosToUsers(
    @common.Param() params: UserWhereUniqueInput,
    @common.Body() body: PhotoWhereUniqueInput[]
  ): Promise<void> {
    const data = {
  ...
  @common.Delete("/:id/photosToUsers")
  async disconnectPhotosToUsers(
    @common.Param() params: UserWhereUniqueInput,
    @common.Body() body: PhotoWhereUniqueInput[]
  ): Promise<void> {
    const data = {
